    ...
    <div className="w-full h-full text-center">
      ...
      <div className="w-full relative flex justify-center md:justify-between md:gap-4 items-center">
        ...
        <div className="w-full flex justify-center items-center">
          <div className="w-[20rem] flex flex-col justify-center gap-2 ml-12  mt-6 text-center">
            <input
              type="text"
              placeholder="Name"
              required={true}
            ...
            <button
              ...
              className="px-3 py-1 outline-none flex justify-center items-center gap-1 font-semibold text-2xl rounded-xl text-black my-4 bg-gradient-to-br from-pink-500 to-orange-400 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-pink-200 dark:focus:ring-pink-800 text-center me-2 mb-2"
            >
              {loading ? <div className="inline">
                <div role="status">
                  <svg
                    aria-hidden="true"
