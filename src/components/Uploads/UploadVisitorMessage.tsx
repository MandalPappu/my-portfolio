  ...
  return (
    <div className="w-full h-full bg-black">
      ...
      <div className="w-full relative flex justify-between items-center ">
        ...
        <div className="w-full sm:mx-auto px-8 ">
          <div className="w-[20rem] flex flex-col gap-2 ml-4 mt-6">
            <input
              type="text"
              placeholder="Name"
              required={true}
            ...
            <button
              ...
              className="bg-green-400 hover:bg-green-700 rounded-xl text-black px-2 mx-auto py-2 font-bold text-lg mt-4"
            >
